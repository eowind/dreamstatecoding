...
namespace techdump.opengl.Components
{
    public class GameObjectFactory : IDisposable
    {
        ...
        {
            return CreateAsteroid("Golden", GetRandomPosition());
        }
        ...
        public AGameObject CreateGameOver()
        {
            var obj = new GameOverCube(_models["Gameover"], new Vector4(0, 0, Z, 0), Vector4.Zero, Vector4.Zero, 0.0f);
